...
# Read the CSV files
"D:/Data Science Project/B18 Project/DataSets/DDW_B18_0800_NIC_FINAL_STATE_RAJASTHAN-2011.csv"
df1 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18st_2100_NIC_FINAL_STATE_ODISHA-2011.csv",encoding='ISO-8859-1')
df2 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18st_1800_NIC_FINAL_STATE_ASSAM-2011.csv",encoding='ISO-8859-1')
df3 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18st_1300_NIC_FINAL_STATE_NAGALAND-2011.csv",encoding='ISO-8859-1')
df4 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18st_1100_NIC_FINAL_STATE_SIKKIM-2011.csv",encoding='ISO-8859-1')
df5 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18st_1000_NIC_FINAL_STATE_BIHAR-2011.csv",encoding='ISO-8859-1')
df6 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18st_0900_NIC_FINAL_STATE_UTTAR_PRADESH-2011.csv",encoding='ISO-8859-1')
df7 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18st_0500_NIC_FINAL_STATE_UTTARAKHAND-2011.csv",encoding='ISO-8859-1')
df8 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18st_0200_NIC_FINAL_STATE_HIMACHAL_PRADESH-2011.csv",encoding='ISO-8859-1')
df9 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_3400_NIC_FINAL_STATE_PUDUCHERRY-2011.csv",encoding='ISO-8859-1')
df10 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_3300_NIC_FINAL_STATE_TAMIL_NADU-2011.csv",encoding='ISO-8859-1')
df11 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_3200_NIC_FINAL_STATE_KERALA-2011.csv",encoding='ISO-8859-1')
df12 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_3000_NIC_FINAL_STATE_GOA-2011.csv",encoding='ISO-8859-1')
df13 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_2900_NIC_FINAL_STATE_KARNATAKA-2011.csv",encoding='ISO-8859-1')
df14 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_2700_NIC_FINAL_STATE_MAHARASHTRA-2011.csv",encoding='ISO-8859-1')
df15 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_2400_NIC_FINAL_STATE_GUJARAT-2011.csv",encoding='ISO-8859-1')
df16 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_2000_NIC_FINAL_STATE_JHARKHAND-2011.csv",encoding='ISO-8859-1')
df17 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_1600_NIC_FINAL_STATE_TRIPURA-2011.csv",encoding='ISO-8859-1')
df18 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18sc_0700_NIC_FINAL_STATE_NCT_OF_DELHI-2011.csv",encoding='ISO-8859-1')
df19 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18_1500_NIC_FINAL_STATE_MIZORAM-2011.csv",encoding='ISO-8859-1')
df20 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18_1400_NIC_FINAL_STATE_MANIPUR-2011.csv",encoding='ISO-8859-1')
df21 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18_1200_NIC_FINAL_STATE_ARUNACHAL_PRADESH-2011.csv",encoding='ISO-8859-1')
df22 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18_0800_NIC_FINAL_STATE_RAJASTHAN-2011.csv",encoding='ISO-8859-1')
df23 = pd.read_csv("D:/Data Science Project/B18 Project/DataSets/DDW_B18_1900_NIC_FINAL_STATE_WEST_BENGAL-2011.csv",encoding='ISO-8859-1')
# Concatenate the dataframes
# List of dataframes
dfs = [df1, df2, df3, df4, df5, df6, df7, df8, df9, df10, df11, df12, df13, df14, df15, df16, df17, df18, df19, df20, df21, df22, df23]
# Check each DataFrame in the list
for i, df in enumerate(dfs):
    if not isinstance(df, pd.DataFrame):
        raise TypeError(f"Object at index {i} is not a valid Pandas DataFrame.")
# Concatenate the dataframes
